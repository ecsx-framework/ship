defmodule ShipWeb.ConnCase do
  ...
  by setting `use ShipWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      import ShipWeb.ConnCase
    end
  end

  setup tags do
    Ship.DataCase.setup_sandbox(tags)
  ...
  def register_and_log_in_player(%{conn: conn}) do
    player = Ship.PlayersFixtures.player_fixture()
  ...
  def log_in_player(conn, player) do
    token = Ship.Players.generate_player_session_token(player)
